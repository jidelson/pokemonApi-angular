...
export class PokedexComponent implements OnInit { 
  ...
  // this is the input variable referred to by the 2 way binding in HTML (user input goes in here)
  public input: number = 0; 

  // pokemon type object to hold the Pokemon that gets returned as an oservable after the HTTP request
  public pokemon:any = null; // we assigned the pokemon variable type any so that we can leave it null 
